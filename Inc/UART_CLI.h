...
static const CLI_Command_Definition_t xSetShutdownTimer =
{
...
static const CLI_Command_Definition_t xPowerOnButtonEnable =
{
	( const int8_t * const ) "poweronbutton-enable",
	( const int8_t * const ) "poweronbutton-enable:\r\n Enables <1> or disables <0> the PowerOn-Button\r\n\r\n",
	prvPowerOnButtonEnable,
	1
};

static const CLI_Command_Definition_t xPowerOnButtonTime =
{
	( const int8_t * const ) "poweronbutton-timer",
	( const int8_t * const ) "poweronbutton-timer <seconds>:\r\n Sets the Timer for the PowerOn-Button Initialization to <seconds>\r\n\r\n",
